...
public class OperadorNao {
	...
	public static void main(String[] args) {
		/*
		 * Crie um programa que receba o tipo de um usuário em uma variável String e
		 * caso esse tipo NÃO SEJA "administrador", exibir a mensagem:
		...
		if (!tipoUsuario.equals("administrador")) {
			System.out.println("Usuário sem poderes administrativos");
		}
		leitor.close();
